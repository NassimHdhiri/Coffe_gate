...
import MenuItemsCard from '../../../components/client/menu/MenuItemsCard';
import CategoryItem from '../../../components/client/menu/CategoryItem'
import SearchTopBar from '../../../components/client/menu/SearchBar';
import EventCard from '../../../components/client/menu/EventCard';
import BottomBar from '../../../components/client/menu/BottomBar';
  ...
  return (
    ...
    >
      <View style={styles.container}>
        {/* Header */}
        <Header containerStyle={{ height:100, backgroundColor: 'transparent' }}
        placement="left"
        leftComponent={
